...
public class Student {
     ...
     *
     * @param bookIssuingIndex The index where the book is issuing.
    ...
    public void issueBooksToStudents(int bookIssuingIndex, String bookName) {
        namesOfTheBooksIssuedByTheStudent[bookIssuingIndex].setBookName(bookName);
    }
    ...
    public boolean returnBook(String bookName) {
        ...
        for (int tempIndex = 0; tempIndex < MAXIMUM_BOOKS_STUDENT_CAN_ISSUE; tempIndex++) {
            if (bookName.equals(namesOfTheBooksIssuedByTheStudent[tempIndex].getBookName())) {
        ...
        if (returnSuccessful) {
            namesOfTheBooksIssuedByTheStudent[returnBookIndex].setBookName(null);
        } else {
